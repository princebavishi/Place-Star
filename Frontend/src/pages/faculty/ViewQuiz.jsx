          ...
          <table className=''>
            <tbody>
              <tr>
                ...
                <td className="text-gray-600">: {preserveLineBreaks(QuizDetails.Subject || '')}</td>
              </tr>
              <tr>
                <td className="text-secondary font-semibold pr-4">Title</td>
                <td className="text-gray-600">: {preserveLineBreaks(QuizDetails.Title || '')}</td>
              </tr>
              <tr>
                <td className="text-secondary font-semibold pr-4">Description</td>
                <td className="text-gray-600">: {preserveLineBreaks(QuizDetails.Description || '')}</td>
              </tr>
              <tr>
          ...
          <div key={index}>
            <div className="flex gap-2">
              <h3 className="text-primary font-bold ">
                {index + 1} : {preserveLineBreaks(question.QuestionText)}
              </h3>
            ...
            <div className=" "><span className="p-2 font-semibold">Options:</span>
              <div className="p-2">A: {preserveLineBreaks(question.options[0].OptionA)}</div>
              <div className="p-2">B: {preserveLineBreaks(question.options[0].OptionB)}</div>
              <div className="p-2">C: {preserveLineBreaks(question.options[0].OptionC)}</div>
              <div className="p-2">D: {preserveLineBreaks(question.options[0].OptionD)}</div>
            </div>
